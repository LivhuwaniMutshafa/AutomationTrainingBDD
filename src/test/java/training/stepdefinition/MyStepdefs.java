...
public class MyStepdefs {
    ...
    public void a_user_enters_the_and_and_clicks_login() throws Exception {
     try {
         rs = data.ConnectAndQuerySQL("jdbc:mysql://localhost:3306/data",
                 "root", "Livhu98#", "Select * from login");
    ...
    public void a_user_populates_fields_in_the_search_page_and_clicks_continue() throws Exception {
        try {
            rs2 = data.ConnectAndQuerySQL("jdbc:mysql://localhost:3306/booking",
                    "root", "Livhu98#", "Select * from dataexcel");
